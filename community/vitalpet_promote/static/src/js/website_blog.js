odoo.define('vitalpet_promote.vitalpet_promote', function (require) {
"use strict";
...
function shareArticle(event){
    ...
    if ($(this).is('*[class*="_complete"]')) {
        ...
        var promote_post = $(this).parents("[name='promote_post']");
        var blog_post_title = promote_post.find('.o_blog_post_title').html() || '';
        var blog_article_link = promote_post.find('.o_blog_post_title').parent('a').attr('href');
