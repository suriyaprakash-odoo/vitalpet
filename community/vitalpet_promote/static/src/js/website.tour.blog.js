odoo.define("vitalpet_promote.tour", function (require) {
    "use strict";
    ...
    tour.register("blog", {
        ...
        trigger: "a[data-action=new_promote_post]",
        content: _t("Select this menu item to create a new blog post."),
        position: "bottom",
    }, {
        trigger: "h1[data-oe-expression=\"promote_post.name\"]",
        ...
        extra_trigger: "#wrap h1[data-oe-expression=\"promote_post.name\"]:not(:containsExact(\"\"))",
