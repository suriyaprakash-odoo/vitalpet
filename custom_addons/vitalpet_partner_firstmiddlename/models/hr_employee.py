...
class Employee(models.Model):
    ...
    def create(self, vals):        
        ...
        return super(Employee, self.with_context(context)).create(vals)
    ...
    def copy(self, default=None):
        ...
        and lastname fields.
        """
        return super(Employee, self.with_context(copy=True)).copy(default)

    @api.model
    def default_get(self, fields_list):
        """Invert name when getting default values."""
        result = super(Employee, self).default_get(fields_list)
    ...
    def _get_computed_name(self, lastname, firstname, middlename):
        ...
        if order == 'last_first_comma':
            return u", ".join((p for p in (lastname, firstname+' '+middlename) if p))
