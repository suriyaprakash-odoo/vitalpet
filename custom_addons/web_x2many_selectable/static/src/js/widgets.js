...
var X2ManySelectable = FieldOne2Many.extend({
	   ...
	   action_selected_lines: function()
	   {
		...
		var model_obj=new Model('expense.bank.statement.import'); //you can hardcode model name as: new Model("module.model_name");
		//you can change the function name below
		model_obj.call('bulk_unlink',[selected_ids],{context:self.dataset.context})
