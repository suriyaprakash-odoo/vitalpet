odoo.define('sales_summary.listview_extend', function (require) {
"use strict";
...
var _lt = core._lt;
alert('Hi');
var SalesSummaryDashboardView = KanbanView.extend({
...
core.view_registry.add('sales_team_dashboard', SalesSummaryDashboardView);

return SalesSummaryDashboardView;
