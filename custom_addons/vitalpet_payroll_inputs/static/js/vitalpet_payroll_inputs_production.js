/*global $, _, PDFJS */
odoo.define('vitalpet_payroll_inputs.action_payroll_input_production', function (require) {
"use strict";
...
var Dashboard = Widget.extend(ControlPanelMixin, {
    template: "vitalpet_payroll_inputs.ProductionHomePage",
    ...
    init: function(parent, context) {
        ...
        this.dashboards_templates = ['vitalpet_payroll_inputs.ProductionPage'];
    },
    start: function() {
        var self = this;
...
//    //To update breadcrumbs
    ...
    on_bonus_amount_changed: function(ev) {
    	...
    	new Model('hr.production').call('update_bonus_amount', [amount,period_id,employee_id,job_id,bonus_id,bonus_date]).then(function(result){
    		console.log(result);
    	});
    },
 ...
 // Change events
    ...
    render_dashboards: function() {
	    ...
	    console.log(this.context)
	        _.each(this.dashboards_templates, function(template) {
	        	 new Model('vitalpet.payroll.inputs.production').call('fetch_production_data', []).then(function(result){
		      		 self.$('.o_website_dashboard').append(QWeb.render(template, {widget: self,values: result,}));
    ...
    core.action_registry.add('action_payroll_input_production', Dashboard);
    return Dashboard;
});
