...
#     @api.onchange("name")
#     def _onchange_name_change(self):
#         if self.name and self.company_type == 'company':
#             obj=self.name.split()
#             print obj,'pppp'
#             if obj[0]:
#                 self.firstname = obj[0] or '' 
#             if obj[1]:
#                 self.middlename = obj[1] or ''
#             if obj[2]:
#                 self.lastname = obj[2] or ''
    ...
    @api.model
    def _get_computed_name(self, firstname, lastname, middlename):
