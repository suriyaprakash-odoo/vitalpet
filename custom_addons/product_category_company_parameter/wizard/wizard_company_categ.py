...
#     asset_category_id = fields.Many2one('account.asset.category', 'Category')
    ...
    def confirm(self):
        ...
        context['income_account_id'] = self.income_account_id and self.income_account_id.id or False  
        context['expense_account_id'] = self.expense_account_id and self.expense_account_id.id or False
